...
export default function Button({
    ...
    const basesStyles = 'inline-flex items-center justify-center font-regular rounded-sm transition-all - focus:outline-none focus:ring-1 focus:ring-offset-2 cursor-pointer px-2 py-1';
